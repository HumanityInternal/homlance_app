    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="orders-nav" class="nav-content collapse" data-bs-parent="#sidebar-nav">
          <li>
            <a href="<%=request.getContextPath()%>/admin/pending_order">

              <i class="bi bi-circle"></i><span>Pending Orders</span>
            </a>
          </li>
          <li>
            <a href="<%=request.getContextPath()%>/admin/completed_order">
              <i class="bi bi-circle"></i><span>Completed Orders</span>
            </a>
          </li>
          <li>
            <a href="<%=request.getContextPath()%>/admin/cancelled_order">
      ...
      <li class="nav-item">
        ...
        <ul id="Products-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="<%=request.getContextPath()%>/admin/add_category">
              <i class="bi bi-circle"></i><span>Add Category</span>
            </a>
          </li>
          <li>
            <a href="<%=request.getContextPath()%>/admin/all_product">
              <i class="bi bi-circle"></i><span>All Products</span>
            </a>
          </li>
          <li>
            <a href="<%=request.getContextPath()%>/admin/add_product">
        ...
        <ul id="Customers-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="<%=request.getContextPath()%>/admin/customers">
              <i class="bi bi-circle"></i><span>Customers Details</span>
            </a>
          </li>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#Analytics-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-clipboard-data"></i><span>Analytics & Reports</span><i
        ...
        <ul id="Analytics-nav" class="nav-content collapse" data-bs-parent="#sidebar-nav">
          ...
          <li>
           ...
           <li class="nav-item">
                  <a class="nav-link" href="<%=request.getContextPath()%>/admin/newuser">
           ...
           <li class="nav-item">
                             <a class="nav-link" href="<%=request.getContextPath()%>/admin/faqs">
